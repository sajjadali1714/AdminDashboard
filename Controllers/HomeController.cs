...
public class HomeController : Controller
{
    ...
    public ActionResult SalesDetail(string dateRange, string startDate, string endDate)
    {
    ...
    public IActionResult ProductDashboard(string dateRange, string startDate, string endDate)
    {
        var paststartDate = "";
        var pastendDate = "";
        ...
        if (dateRange == "Current Year")
        {
            ...
            paststartDate = DateTime.Now.AddYears(-1).ToString("yyyy") + "-01-01";
            pastendDate = DateTime.Now.AddYears(-1).ToString("yyyy-MM-dd");
        }
        else if (dateRange == "6 Months")
        {
            // Fetch data for the last 6 months
            ...
            paststartDate =  DateTime.Now.AddMonths(-6).AddYears(-1).ToString("yyyy-MM") + "-01";
            pastendDate = DateTime.Now.AddYears(-1).ToString("yyyy-MM-dd");
        }
        else if (dateRange == "Current Month")
        {
            ...
            paststartDate = DateTime.Now.AddYears(-1).ToString("yyyy-MM") + "-01";
            pastendDate = DateTime.Now.AddYears(-1).ToString("yyyy-MM-dd");
        }
        else if (dateRange == "Date")
        {
            ...
            if (startDate.Length > 0 && endDate.Length > 0){
                ...
                paststartDate = DateTime.Parse(startDate).AddYears(-1).ToString("yyyy-MM-dd");
                pastendDate = DateTime.Parse(endDate).AddYears(-1).ToString("yyyy-MM-dd");
            }            
        } else{
        ...
        {            
            TotalRevenueProductCategory = ProductDashboard.GetProductDetail("TotalSalesAmount","sum",startDate,endDate,"","ProductCategoryName"),
            PastTotalRevenueProductCategory = ProductDashboard.GetProductDetail("TotalSalesAmount","sum",paststartDate,pastendDate,"","ProductCategoryName"),
            
            TotalOrdersProductCategory = ProductDashboard.GetProductOrderDetail("id","count",startDate,endDate,"ProductCategoryName"),
            ProductCategoryByMale = ProductDashboard.GetProductDetail("TotalSalesAmount","sum",startDate,endDate,"And gender = 'Male'","Gender,ProductCategoryName"),
            ProductCategoryByFemale = ProductDashboard.GetProductDetail("TotalSalesAmount","sum",startDate,endDate,"And gender = 'Female'","Gender,ProductCategoryName"),
            CommonPaymentMethod = ProductDashboard.GetProductDetail("TotalSalesAmount","sum",startDate,endDate,"","PaymentTypeName"),
            AverageRatingProductCategory = ProductDashboard.GetProductDetail("Rating","avg",startDate,endDate,"","ProductCategoryName"),
            CaliforniaBranchProductCategoryRevenue = ProductDashboard.GetProductDetail("TotalSalesAmount","sum",startDate,endDate,"And BranchName = 'California'","BranchName,ProductCategoryName"),
            FloridaBranchProductCategoryRevenue = ProductDashboard.GetProductDetail("TotalSalesAmount","sum",startDate,endDate,"And BranchName = 'Florida'","BranchName,ProductCategoryName"),
            TexasBranchProductCategoryRevenue = ProductDashboard.GetProductDetail("TotalSalesAmount","sum",startDate,endDate,"And BranchName = 'Texas'","BranchName,ProductCategoryName"),
    ...
    public IActionResult ProductDetail(string dateRange, string startDate, string endDate)
    {
        ...
        ProductDetailViewModel.ProductCategorySale = ProductDetail.GetProductCategorySalesDetail("ProductCategoryName", startDate, endDate);
        ProductDetailViewModel.ProductSale = ProductDetail.GetProductCategorySalesDetail("ProductName", startDate, endDate);
        ViewBag.ProductCategoryDetail = ProductDetailViewModel;
    ...
    public IActionResult CustomerDetail(string dateRange, string startDate, string endDate)
    {
